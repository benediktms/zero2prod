...
async fn validate_credentails(
    ...
    user_id.ok_or_else(|| PublishError::AuthError(anyhow::anyhow!("Unknown usernmae.")))
}
...
pub async fn publish_newsletter(
    ...
    let user_id = validate_credentails(credentials, &pool).await?;
